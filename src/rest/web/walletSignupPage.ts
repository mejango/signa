...
<div id="signup-links"><button type="button" id="signup-restart" class="quiet" hidden>Start over</button><a href="#" id="signup-resume" hidden>Signa in</a><a id="signup-fullscreen" target="_top" rel="noopener" title="Fullscreen" hidden>Fullscreen</a></div>
